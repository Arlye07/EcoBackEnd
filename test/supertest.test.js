...
const {testerEmail, testerPassword} = require('../src/config/superAdmin.config')
const {cartId, productId} = require('../src/config/utils.config')
...
describe('test de productos', () => {
  ...
  xit('El endpoint GET /api/dbProducts debe de mostrar todos los productos con o sin filtros', async () => {
  ...
  xit('El endpoint POST /api/dbProducts agrega un nuevo producto a la base de datos', async () => {
  ...
  xit('El endpoint PUT /api/dbProducts/:productId actualiza un producto en la base de datos', async () => {
  ...
  xit('El endpoint DELETE /api/dbProducts/:productId elimina un producto de la base de datos', async () => {
    // Agrega un producto inicialmente a la base de datos para obtener su ID
    const randomProduct = {
...
describe('test de carrito', () => {
  ...
  xit('El endpoint GET /api/dbCarts/:cid  obtiene un carrito en especifico',async () => {
  ...
  xit('El endpoint POST /api/dbCarts/cartId/:productId agrega un producto en especifico a un carrito',async () => {
  ...
  xit('El endpoint PUT /api/dbCarts/:cid/products/:pid actualiza solo la cantidad de unidades de un producto dentro del carrito', async () => {
  ...
  xit('El endpoint PUT /api/dbCarts/:cid actualiza el arreglo de productos del carrito', async () => {
  ...
  xit('El endpoin POST /api/dbCarts/:cid/products/:pid elimina del carrito el producto seleccionado', async  () => {
  ...
  xit('El enpoint DELETE /api/dbCarts/:cid elimina todos los productos que exitan en el carrito', async () => {
